...
- Never commit `.sdd/` runtime state, credentials, private inputs, generated sessions/transcripts, databases, or source PDFs; only `.sdd/README.md` and reviewed `.sdd/history/**` snapshots may be tracked.
