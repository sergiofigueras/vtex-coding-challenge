...
Read `docs/sdd/manifest.json`, `docs/sdd/traceability.json`, the requested specifications, their dependencies, and `.dsh/skills/sdd-delivery/SKILL.md` before editing.
