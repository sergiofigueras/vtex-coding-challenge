...
- **AC-008-04:** Assessment-critical SDD-000 through SDD-007 and the operational-limits SDD-010 are `implemented` or `verified` with criterion-level evidence before this release review. The final revision is reported after the later SDD-009 history/documentation step.
