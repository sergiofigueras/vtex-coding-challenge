...
1. Read `AGENTS.md`, `docs/sdd/manifest.json`, and `docs/sdd/traceability.json`.
...
Do not access environment secrets, source PDFs, ignored fixtures except through documented test commands, or paths outside the repository. Do not commit or push. Do not modify existing cost-ledger bytes. End with:
