...
export async function loadSdd(root) {
...
export async function buildAgentPrompt(root, changeId, requestedIds) {
  const { byId } = await loadSdd(root)
...
export async function specText(root, spec) {
  return readFile(resolve(root, spec.path), 'utf8')
}
